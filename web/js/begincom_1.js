...
function showMessages()
{
    ...
    var myxsl = loadXML("/Sport1/users/xml/comadmin.xsl");
...
function addNewMessage()
{
    ...
    var str_post = "name=" + getCookie("name") + " " + getCookie("sername") + " (Администратор)" + "&message=" + textar.value;
    var req = getXmlHttpRequest();
  /*  req.onreadystatechange = function()
    {
      if (req.readyState===4)
...
function delMes(e)
{
    ...
    req.open("POST","/Sport1/DeleteMessageServlet",true);
    req.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    req.setRequestHeader("Content-length",str_post.length);
    req.send(str_post);
